## This node is made for driving the Brushed DC motors, collecting the IMU data (Accelerometer+Gyroscope+Magnetometer), and for controlling the payload system.
