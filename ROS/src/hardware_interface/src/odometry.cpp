...
: timestamp_(0.0),
  x_(0.0), // all distances in meters
  y_(0.0),
  heading_(0.0),
  linear_(0.0),
  angular_(0.0),
  wheel_separation_(0.682),
  left_wheel_radius_(0.150),
  right_wheel_radius_(0.150),
...
bool Odometry::updateFromVelocity(double left_vel, double right_vel, const rclcpp::Time & time)
{
  ...
  const double linear = (left_vel + right_vel) * 0.5; // meters per second
  // Now there is a bug about scout angular velocity
  const double angular = (right_vel - left_vel) / wheel_separation_; // radians per second
...
bool Odometry::updateFromVelocity(double left_vel, double right_vel, double dt)
{
  // Compute linear and angular diff:
  const double linear = (left_vel + right_vel) * 0.5; // meters per second
  // Now there is a bug about scout angular velocity
